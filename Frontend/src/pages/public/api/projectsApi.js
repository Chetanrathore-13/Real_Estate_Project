...
const API_BASE_URL = `${import.meta.env.VITE_API_URL}/project/projects` // Change this to your actual API base URL
...
export async function getProjectBySlug(slug) {
  try {
    const response = await axios.get(`${import.meta.env.VITE_API_URL}/project/get_project/${slug}`)
    console.log(response.data)
...
export async function getProjectTypes() {
  try {
    const response = await axios.get(`${import.meta.env.VITE_API_URL}/projectType/get_projectTypes`,)
