...
const PropertyStatusManager = () => {
  ...
  const fetchStatuses = async () => {
    try {
      const { data } = await axios.get(`${import.meta.env.VITE_API_URL}/property/property_status`, {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        ...
        await axios.patch(`${import.meta.env.VITE_API_URL}/property/update_property_status/${editingId}`, formData, {
          headers
          }
        );
      } else {
        await axios.post(`${import.meta.env.VITE_API_URL}/property/add_property_status`, formData, {
          headers
         });
      }
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`${import.meta.env.VITE_API_URL}/property/delete_property_status${id}`, {
        headers: { Authorization: token },
      });
      fetchStatuses();
    } catch (error) {
