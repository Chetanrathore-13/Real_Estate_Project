...
export default function StateManager() {
  ...
  const addCity = async (name, code,icon,description) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL}/location/add_city`,
        formData,
        {
          headers: {
            Authorization: token,
  ...
  const deleteCity = async (id) => {
    ...
    console.log(cities)
    try {
      await axios.delete(`${import.meta.env.VITE_API_URL}/location/delete_city/${id}`, {
        headers: { Authorization: token },
      });
  ...
  const updateCity = async (id, name, code) => {
    ...
    try {
      const respone = await axios.patch(`${import.meta.env.VITE_API_URL}/location/patch_city/${id}`, {
        name,
        code
      }, {
        headers: {
