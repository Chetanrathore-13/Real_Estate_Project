...
export default function ProjectTypes() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (editingSlug) {
      ...
      await axios.patch(
        `${import.meta.env.VITE_API_URL}/projectType/update_projectType/${editingSlug}`,
        formDataToSend,
        {
          headers: {
      ...
      await axios.post(
        `${import.meta.env.VITE_API_URL}/projectType/add_projectType`,
        formDataToSend,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const handleDelete = async (slug) => {
    try {
      await axios.delete(
        `${import.meta.env.VITE_API_URL}/projectType/delete_projectType/${slug}`,
        { headers: { Authorization: token } }
      );
      fetchTypes();
    } catch (error) {
