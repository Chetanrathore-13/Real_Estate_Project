...
const PropertyForm = () => {
    ...
    const fetchAgent = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_URL}/agent/agents`,
          {
  ...
  useEffect(() => {
    const fetchPropertyTypes = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_URL}/property/property_types`,
          {
            headers: { Authorization: token },
          }
        );
  ...
  useEffect(() => {
    const fetchPropertyStatus = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_URL}/property/property_status`,
          {
            headers: { Authorization: token },
          }
        );
  ...
  useEffect(() => {
    const fetchPropertyLabels = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_URL}/property/property_labels`,
          {
            headers: { Authorization: token },
          }
        );
  ...
  useEffect(() => {
    const fetchFeature = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_URL}/property/property_features`,
          {
            headers: { Authorization: token },
          }
        );
  ...
  useEffect(() => {
    if (countryId) {
      const fetchStates = async () => {
        try {
          const response = await axios.get(
            `${import.meta.env.VITE_API_URL}/location/states/${countryId}`,
            { headers: { Authorization: token } }
          );
  ...
  useEffect(() => {
    if (countryId && stateId) {
      const fetchCities = async () => {
        try {
          const response = await axios.get(
            `${import.meta.env.VITE_API_URL}/location/cities/${stateId}`,
            { headers: { Authorization: token } }
          );
