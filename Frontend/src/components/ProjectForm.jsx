...
const ProjectForm = () => {
    ...
    const fetchAgent = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_URL}/agent/get_agents`,
          {
  ...
  useEffect(() => {
    const fetchAgent = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_URL}/projectFeature/get_projectFeature`,
          {
            headers: { Authorization: token },
          }
        );
  ...
  useEffect(() => {
    const fetchAgent = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_URL}/projectType/get_projectTypes`,
          {
            headers: { Authorization: token },
          }
        );
  ...
  useEffect(() => {
    const fetchAgent = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_URL}/property/properties`,
          {
            headers: { Authorization: token },
          }
        );
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL}/project/add_project`,
        formData,
        {
          headers: {
            Authorization: token,
