...
const PropertyList = () => {
  ...
  const fetchProperties = async () => {
    setLoading(true);
    try {
      const { data } = await axios.get(`${import.meta.env.VITE_API_URL}/property/properties`, {
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this property?")) {
      try {
        await axios.delete(`${import.meta.env.VITE_API_URL}/property/delete_property/${id}`,{headers:{Authorization:token}});
